      ...
      <main>
        <section className="pt-140 pb-56">
          <Container>
            ...
            <p className="mt-16 font-mono text-[11px] uppercase tracking-[0.2em] text-ash">
        ...
        <section className="bg-paper py-88 text-paper-text">
          <Container>
            <div className="mx-auto max-w-measure space-y-56">
              ...
              <div>
                <h2 className="font-serif text-[22px] text-paper-text">What we collect</h2>
                <div className="mt-16 space-y-16 font-serif text-reader text-paper-text/80">
                  <p>
                    <strong className="text-paper-text">Email address.</strong> Submitted through
                  ...
                  <p>
                    <strong className="text-paper-text">Commission request details.</strong> If
                  ...
                  <p>
                    <strong className="text-paper-text">Order details.</strong> If you buy a
                  ...
                  <p>
                    <strong className="text-paper-text">Standard server logs.</strong> Like
              ...
              <div>
                <h2 className="font-serif text-[22px] text-paper-text">Who else touches it</h2>
                ...
                <div className="mt-16 divide-y divide-paper-text/10 border-y border-paper-text/10">
                  {[
                    ...
                    <div key={row.name} className="flex flex-col gap-4 py-16 md:flex-row md:justify-between md:gap-24">
                      <span className="font-sans text-[15px] font-medium text-paper-text">{row.name}</span>
                      <span className="max-w-[38ch] font-serif text-[15px] text-paper-text/70">{row.role}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div>
                <h2 className="font-serif text-[22px] text-paper-text">Cookies</h2>
                <p className="mt-16 font-serif text-reader text-paper-text/80">
              ...
              <div>
                <h2 className="font-serif text-[22px] text-paper-text">How long we keep it</h2>
                <p className="mt-16 font-serif text-reader text-paper-text/80">
              ...
              <div>
                <h2 className="font-serif text-[22px] text-paper-text">Your rights</h2>
                <p className="mt-16 font-serif text-reader text-paper-text/80">
              ...
              <div>
                <h2 className="font-serif text-[22px] text-paper-text">Where it&rsquo;s processed</h2>
                <p className="mt-16 font-serif text-reader text-paper-text/80">
              ...
              <div>
                <h2 className="font-serif text-[22px] text-paper-text">Changes</h2>
                <p className="mt-16 font-serif text-reader text-paper-text/80">
